...
export default function AnimatedNumberCounter({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-0.5 sm:py-1 md:py-1.5 animate-slideInUp">
      <div className="text-center">
        {shouldShowNumber && (
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white mb-0.5 sm:mb-1 md:mb-1.5 tabular-nums">
