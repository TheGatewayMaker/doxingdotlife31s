      ...
      <main className="flex-1 w-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          >
            ...
            >
              ...
              <div className="relative">
                <textarea
                  ...
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-background/50 border-2 border-border/60 hover:border-accent/60 rounded-lg sm:rounded-xl text-foreground placeholder-muted-foreground focus:outline-none focus:border-accent resize-none transition-all duration-200 text-sm"
                  rows={4}
            ...
            >
              <div className="relative flex items-start sm:items-center gap-3 bg-gray-600/15 border-2 border-gray-400/40 hover:border-gray-400/60 rounded-lg sm:rounded-2xl p-4 sm:p-6 transition-all duration-300 hover:shadow-lg hover:shadow-gray-400/10">
                <input
                  type="checkbox"
                  id="blur-checkbox"
                  checked={blurThumbnail}
                  onChange={(e) => setBlurThumbnail(e.target.checked)}
                  className="w-4 h-4 sm:w-5 sm:h-5 accent-white rounded cursor-pointer flex-shrink-0 mt-0.5 sm:mt-0 border border-gray-400"
                />
                <label
                ...
                >
                  <div className="flex items-center gap-2 mb-0.5 sm:mb-1">
                    ...
                    <p className="text-xs sm:text-sm font-black text-gray-300">
                      Blur Thumbnail
                    </p>
                  </div>
                  <p className="text-xs font-semibold text-gray-400 ml-5.5 sm:ml-6">
